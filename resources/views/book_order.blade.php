        ...
        <div class="col-12 col-md-6 d-flex flex-column align-items-center" id="">
            ...
            <div class="d-flex justify-content-center align-items-center">
                <ul class="list-unstyled d-flex">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body d-flex justify-content-center align-items-center">
                                    <img src="{{ URL("storage/book_images/".$image) }}" alt="" style="height: 400px">
                                </div>
                    ...
                    <!-- second -->
                    {{-- <li class="me-2" style="width: 50px; height: 50px;">
                        <img src="<?= $images ?>" alt="" style="width: 100%; height: 100%; object-fit: cover;" id="zoomImg" data-bs-toggle="modal" data-bs-target="#second">
                    </li>
                    <div class="modal fade" id="second" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body d-flex justify-content-center align-items-center">
                                    <img src="<?= $images ?>" alt="" style="height: 400px">
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Got it!</button>
                    ...
                    <!-- third -->
                    <li class="me-2" style="width: 50px; height: 50px;">
                        <img src="<?= $images ?>" alt="" style="width: 100%; height: 100%; object-fit: cover;" id="zoomImg" data-bs-toggle="modal" data-bs-target="#third">
                    </li>
            ...
            <div class="modal" id="wave" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body d-flex justify-content-center align-items-center">
                            <img src="{{asset("assets/images/wavePay.jpg")}}" alt="" style="height: 300px; object-fit: contain;">
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Got it!</button>
